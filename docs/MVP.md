...
> 实现快照（2026-08-29）：3D 角色、菜单、文字聊天、真实 GLM、角色 Harness、原创曲种子库、SQLite、语音管线和开发机一键启动已经形成基础闭环；Windows 登录自启、进程守护、Startup/Idle Trigger、稳定 STT 验收、权限层和 TTS 尚未完成。后续 Agent 必须以 [`HANDOFF.md`](HANDOFF.md) 的验证状态为准，本文件保留产品范围和验收目标。
