...
| Listening gesture | Active: `listen_mocap_v2.tres`, 61 frames / 2s, 74 upper-body rotation tracks, right hand by ear and authored left hand behind back; no lower-body/translation/scale tracks. Legacy: `listen_gesture`, 8.533s open→fist→open GLB, preserved for rollback |
