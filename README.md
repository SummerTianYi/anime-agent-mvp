...
| 当前外观与下一阶段 | 本地 1.4 五官 A2 + 保守 A-pose（Codex，2026-09-10） | 已批准、测试并重启实装；未提交冻结，正式历史索引仍为 1.3。`ANIME_AGENT_MODEL_LOOK=1.3` 回退旧材质；[证据与本地备份](model-versions/PENDING_1.4.md)。下一阶段仍为小幅、少接触动捕。 |
